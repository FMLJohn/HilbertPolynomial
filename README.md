...
In this repository, we have formalised the Hilbert polynomial of a graded module based on the Hilbert--Serre Theorem. Throughout this page, unless stated otherwise, we assume the following:
```
universe u
variable {A M : Type u}
